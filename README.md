...
Cada vendedor possui as seguintes informações:
...
Fluxograma da função ExcluirPorMatricula.
Fluxograma da função BuscarPorMatricula.
Fluxograma da função BuscarPorNome.
